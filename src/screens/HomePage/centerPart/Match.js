  ...
  return (
    <>
      <div className="max-sm:mt-0 mt-3 s18:mt-[17px] sm:rounded-lg bg-white dark:bg-bluedarkmodecolor shadow-dashboardshadow">
        <div className="sticky max-[420px]:top-[100px] top-28 sm:top-28 md:top-[126px] lg:top-[136px] xl:top-28 s15:top-[112px] s16:top-28 s18:top-[126px] rounded-[6px] bg-white dark:bg-bluedarkmode shadow-dashboardshadow">
          <div className="max-sm:flex-col max-sm:items-start max-sm:p-[15px_15px_0px] flex p-[0px_20px] items-center justify-between border-b-[1px] border-solid border-extralightblue dark:border-lightborderyellow">
