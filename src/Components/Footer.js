...
const Footer = () => {
  return (
    <div className="relative bg-darkblue dark:bg-[#182D4A] pb-[120px] s15:pb-[0px]">
      <div className="w-full max-w-[1565px] px-5 mx-auto">
        <div className="pt-[50px] xl:pt-10 s18:pt-[50px] pb-[30px] md:pb-8 xl:pb-12 2xl:pb-[101px] flex max-sm:flex-col sm:flex-wrap lg:flex-nowrap justify-center gap-[50px] sm:gap-10 xl:gap-28 2xl:gap-[180px]">
          ...
          <div className="w-full sm:w-[45%] lg:max-w-[148px]">
            <h6 className="text-white text-lg font-bold max-sm:text-center mb-5 md:mb-3 s18:mb-5">
              Support And Trust
            </h6>
            <ul className="flex flex-col gap-[17px] md:gap-3 s18:gap-[17px] max-sm:text-center">
              <li>
                <Link to="/" className="text-white text-sm font-normal hover:underline hover:text-yellow transition-all duration-300" >
                  How to play
                </Link>
              </li>
              <li>
          ...
          <div className="w-full sm:w-[45%] lg:max-w-[273px]">
            ...
            <div className="flex flex-col gap-[17px] md:gap-3 s18:gap-5 max-sm:text-center">
          ...
          <div className="w-full sm:w-[45%] lg:max-w-[325px]">
            <h6 className="text-white text-lg font-bold max-sm:text-center mb-5 md:mb-3 s18:mb-5">Licence</h6>
            <div className="flex flex-col gap-[17px] md:gap-3 s18:gap-5 max-sm:text-center">
      ...
      <div className="py-[18px] md:py-3 s18:py-[18px] text-center bg-[#182D4A] dark:bg-[#243753]">
        <p className="text-white text-sm font-normal">
